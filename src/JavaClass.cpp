...
void JavaClass::parseClassFile() {
    ...
    raw.minor_version = reader.readget2();
    raw.major_version = reader.readget2();
#ifdef JJVM_DEBUG_SHOW_VERSION
    Inspector::printClassFileVersion(*this);
#endif
    if (raw.major_version < JAVA_6_MAJOR || raw.major_version > JAVA_9_MAJOR) {
        goto error;
    }
...
#ifdef JJVM_DEBUG_SHOW_CONSTANT_POOL_TABLE
    Inspector::printConstantPool(*this);
#endif

    raw.accessFlags = reader.readget2();
#ifdef JJVM_DEBUG_SHOW_CLASS_ACCESS_FLAGS
...
#ifdef JJVM_DEBUG_SHOW_INTERFACE
...
#ifdef JJVM_DEBUG_SHOW_CLASS_FIELD
...
#ifdef JJVM_DEBUG_SHOW_CLASS_METHOD
...
#ifdef JJVM_DEBUG_SHOW_CLASS_ATTRIBUTE
